...
import { View, Text, TextInput, StyleSheet, ScrollView, Alert, TouchableOpacity, KeyboardAvoidingView, Platform, Keyboard } from 'react-native';
...
export default function PracticeScreen({ navigation, route }) {
  ...
  const nextWord = async () => {
    ...
    setTimeout(() => {
      ...
      // Focus input and show keyboard for next word
      if (inputRef.current) {
        inputRef.current.focus();
      }
    }, 300);
